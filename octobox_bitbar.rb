...
class OctoboxBitbar
  IMAGE = Base64.strict_encode64(File.read(File.join(__dir__, "logo_black.png")))
  IMAGE_INVERTED = Base64.strict_encode64(File.read(File.join(__dir__, "logo_white.png")))
